defmodule Ohno.Sources.GithubAdapter do
  use Tesla

  import ShorterMaps
  @behaviour Ohno.Sources.SourcesAdapter

  @raw_url "https://raw.githubusercontent.com"
  plug(Tesla.Middleware.BaseUrl, "https://api.github.com")
  plug(Tesla.Middleware.JSON, engine: Poison)

  # TODO: get token from Ohno.Sources.Repository
  def client() do
    Tesla.build_client([
  ...
  defp configs do
    Application.get_env(:ohno, Ohno.Sources)
  end
